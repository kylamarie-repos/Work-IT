...
export default function Sidebar() {
    ...
    return (
        <>
            <div className="sidebar p-3 text-white bg-dark border-top" 
                style={{ width: '250px', height: '100vh', position: 'fixed' }}>
                <Link to="/employer/Dashboard" className="d-flex align-items-center mb-3 mb-md-auto me-md-auto text-white text-decoration-none">
